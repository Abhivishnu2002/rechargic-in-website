            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 h-16 px-6 rounded-full bg-white/5 border border-white/10 text-white placeholder:text-white/20 focus:outline-none focus:border-primary/50 transition-colors"
                />
                <Button type="submit" size="lg" className="h-16 px-8 rounded-full bg-primary text-white hover:bg-primary/90 font-bold whitespace-nowrap shadow-xl group">
                  Notify Me
